    ...
    <div className="flex flex-col min-h-screen bg-white dark:bg-zinc-950">
      <header className="px-4 lg:px-6 h-20 flex items-center border-b border-gray-100 dark:border-zinc-900 sticky top-0 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md z-50">
        ...
        <nav className="ml-auto flex gap-4 sm:gap-8">
          <Link className="text-sm font-semibold text-gray-600 dark:text-zinc-400 hover:text-red-600 dark:hover:text-red-500 transition-colors" href="/login">
            Sign In
          </Link>
          <Link 
            className="text-sm font-bold px-5 py-2 bg-red-600 text-white rounded-xl hover:bg-blue-700 transition shadow-lg shadow-red-500/20" 
            href="/login"
          >
            Get Started
          </Link>
      ...
      <main className="flex-1">
        <section className="w-full py-24 lg:py-32 xl:py-48 overflow-hidden relative">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full -z-10 opacity-30 dark:opacity-20 pointer-events-none">
            <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-red-400 blur-[120px] rounded-full" />
            <div className="absolute bottom-[10%] right-[-5%] w-[30%] h-[30%] bg-indigo-400 blur-[100px] rounded-full" />
          </div>
          
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center space-y-8 text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-50 dark:bg-red-900/30 border border-red-100 dark:border-blue-800 text-red-600 dark:text-red-400 text-xs font-bold uppercase tracking-wider animate-in fade-in slide-in-from-bottom-4 duration-1000">
              ...
              <h1 className="text-5xl md:text-7xl font-black tracking-tight text-gray-900 dark:text-white max-w-4xl leading-[1.1] animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
                Master your money with <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-700">precision</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 animate-in fade-in slide-in-from-bottom-16 duration-1000 delay-500">
                <Link 
                  href="/login"
                  className="flex items-center justify-center gap-2 px-8 py-4 bg-red-600 text-white font-bold rounded-2xl hover:bg-blue-700 transition shadow-xl shadow-red-500/25 hover:-translate-y-0.5 active:scale-95"
                >
                  Start Tracking Free
          ...
          <div className="container px-4 md:px-6 mx-auto">
            <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-3">
              <div className="group p-8 bg-white dark:bg-zinc-900 rounded-3xl border border-gray-100 dark:border-zinc-800 shadow-sm hover:shadow-xl transition-all hover:-translate-y-1">
                <div className="w-14 h-14 bg-red-100 dark:bg-red-900/30 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
